...
public class PersonalityTest {
    ...
    int count = 0;
    String[][] allUserEntries = new String[5][4];
    ...
    int eIcounterA = 0, eIcounterB = 0, sNcounterA = 0, sNcounterB = 0;
    int tFcounterA = 0, tfcounterB = 0, jPcounterA = 0, jPcounterB = 0;
    ...
    public static void main(String[] args) {
        PersonalityTest personality = new PersonalityTest();

        personality.nameCollector();
        personality.questionGenerator();
        personality.allQuestions();
        personality.savedQuestions();

    }

    public void nameCollector(){
        ...
        if(!userName.isBlank()){
            ...
            System.out.println("Invalid Entry, Try Again!!. A name should contain only Letters from A to Z");
            nameCollector();
        }
    }
    ...
    public void savedQuestions(){
        ...
        if (userResponse.equalsIgnoreCase("A") || userResponse.equalsIgnoreCase("B")){
            ...
            switch(question){
                case 1:
                    if(userResponse.equalsIgnoreCase("A")){
                        allUserEntries[0][0] = questionContent[0][0];eIcounterA++;}
                    else {
                        allUserEntries[0][0] = questionContent[0][1];eIcounterB++;}
                    break;
                case 5:
                    if(userResponse.equalsIgnoreCase("A")){
                        allUserEntries[1][0] = questionContent[4][0]; eIcounterA++;}
                    else {
                        allUserEntries[1][0] = questionContent[4][1];eIcounterB++;}
                    break;
                case 9:
                    if(userResponse.equalsIgnoreCase("A")){
                        allUserEntries[2][0] = questionContent[8][0]; eIcounterA++;}
                    else {
                        allUserEntries[2][0] = questionContent[8][1];eIcounterB++;}
                    break;
                case 13:
                    if(userResponse.equalsIgnoreCase("A")){
                        allUserEntries[3][0] = questionContent[12][0]; eIcounterA++;}
                    else {
                        allUserEntries[3][0] = questionContent[12][1]; eIcounterB++;}
                    break;
                case 17:
                    if(userResponse.equalsIgnoreCase("A")){
                        allUserEntries[4][0] = questionContent[16][0]; eIcounterA++;}
                    else {
                        allUserEntries[4][0] = questionContent[16][1];eIcounterB++;}
                    break;
            }
            ...
            switch (question){
                ...
                case 6:
                    if(userResponse.equalsIgnoreCase("A")){
                        allUserEntries[1][1] = questionContent[5][0]; sNcounterA++;}
                    else {
                        allUserEntries[1][1] = questionContent[5][1]; sNcounterB++;}
                    break;
                case 10:
                    if(userResponse.equalsIgnoreCase("A")){
                        allUserEntries[2][1] = questionContent[9][0]; sNcounterA++;}
                    else {
                        allUserEntries[2][1] = questionContent[9][1];sNcounterB++;}
                    break;
                case 14:
                    if(userResponse.equalsIgnoreCase("A")){
                        allUserEntries[3][1] = questionContent[13][0]; sNcounterA++;}
                    else {
                        allUserEntries[3][1] = questionContent[13][1];sNcounterB++;}
                    break;
                case 18:
                    if(userResponse.equalsIgnoreCase("A")){
                        allUserEntries[4][1] = questionContent[17][0]; sNcounterA++;}
                    else {
                        allUserEntries[4][1] = questionContent[17][1]; sNcounterB++;}
                    break;
            }
            ...
            switch (question){
                case 3:
                    if(userResponse.equalsIgnoreCase("A")){
                        allUserEntries[0][2] = questionContent[2][0];tFcounterA++;}
                    else {
                        allUserEntries[0][2] = questionContent[2][1];tfcounterB++;}
                    break;
                case 7:
                    if(userResponse.equalsIgnoreCase("A")){
                        allUserEntries[1][2] = questionContent[6][0]; tFcounterA++;}
                    else {
                        allUserEntries[1][2] = questionContent[6][1];tfcounterB++;}
                    break;
                case 11:
                    if(userResponse.equalsIgnoreCase("A")){
                        allUserEntries[2][2] = questionContent[10][0]; tFcounterA++;}
                    else {
                        allUserEntries[2][2] = questionContent[10][1];tfcounterB++;}
                    break;
                case 15:
                    if(userResponse.equalsIgnoreCase("A")){
                        allUserEntries[3][2] = questionContent[14][0]; tFcounterA++;}
                    else {
                        allUserEntries[3][2] = questionContent[14][1];tfcounterB++;}
                    break;
                case 19:
                    if(userResponse.equalsIgnoreCase("A")){
                        allUserEntries[4][2] = questionContent[18][0]; tFcounterA++;}
                    else {
                        allUserEntries[4][2] = questionContent[18][1]; tfcounterB++;}
                    break;
            }
            ...
            switch (question){
                case 4:
                    if(userResponse.equalsIgnoreCase("A")){
                        allUserEntries[0][3] = questionContent[3][0];jPcounterA++; }
                    else {
                        allUserEntries[0][3] = questionContent[3][1]; jPcounterB++;}
                    break;
                case 8:
                    if(userResponse.equalsIgnoreCase("A")){
                        allUserEntries[1][3] = questionContent[7][0];jPcounterA++;}
                    else {
                        allUserEntries[1][3] = questionContent[7][1]; jPcounterB++;}
                    break;
                case 12:
                    if(userResponse.equalsIgnoreCase("A")){
                        allUserEntries[2][3] = questionContent[11][0];jPcounterA++;}
                    else {
                        allUserEntries[2][3] = questionContent[11][1]; jPcounterB++;}
                    break;
                case 16:
                    if(userResponse.equalsIgnoreCase("A")){
                        allUserEntries[3][3] = questionContent[15][0]; jPcounterA++;}
                    else {
                        allUserEntries[3][3] = questionContent[15][1];jPcounterB++;}
                    break;
                case 20:
                    if(userResponse.equalsIgnoreCase("A")){
                        allUserEntries[4][3] = questionContent[19][0]; jPcounterA++;}
                    else {
                        allUserEntries[4][3] = questionContent[19][1];jPcounterB++;}
                    break;
            }
            questionGenerator();
            allQuestions();
    ...
    public void allQuestions(){
        ...
        switch (question) {
            case 1 -> System.out.println(questionContent[0][0] + "  " + questionContent[0][1]);
            case 2 -> System.out.println(questionContent[1][0] + "  " + questionContent[1][1]);
            case 3 -> System.out.println(questionContent[2][0] + "  " + questionContent[2][1]);
            case 4 -> System.out.println(questionContent[3][0] + "  " + questionContent[3][1]);
            case 5 -> System.out.println(questionContent[4][0] + "  " + questionContent[4][1]);
            case 6 -> System.out.println(questionContent[5][0] + "  " + questionContent[5][1]);
            case 7 -> System.out.println(questionContent[6][0] + "  " + questionContent[6][1]);
            case 8 -> System.out.println(questionContent[7][0] + "  " + questionContent[7][1]);
            case 9 -> System.out.println(questionContent[8][0] + "  " + questionContent[8][1]);
            case 10 -> System.out.println(questionContent[9][0] + "  " + questionContent[9][1]);
            case 11 -> System.out.println(questionContent[10][0] + "  " + questionContent[10][1]);
            case 12 -> System.out.println(questionContent[11][0] + "  " + questionContent[11][1]);
            case 13 -> System.out.println(questionContent[12][0] + "  " + questionContent[12][1]);
            case 14 -> System.out.println(questionContent[13][0] + "  " + questionContent[13][1]);
            case 15 -> System.out.println(questionContent[14][0] + "  " + questionContent[14][1]);
            case 16 -> System.out.println(questionContent[15][0] + "  " + questionContent[15][1]);
            case 17 -> System.out.println(questionContent[16][0] + "  " + questionContent[16][1]);
            case 18 -> System.out.println(questionContent[17][0] + "  " + questionContent[17][1]);
            case 19 -> System.out.println(questionContent[18][0] + "  " + questionContent[18][1]);
            case 20 -> System.out.println(questionContent[19][0] + "  " + questionContent[19][1]);
        }

    }

    public void responsesCollation(){
        if(eIcounterA > eIcounterB){collation += "E";} else {collation += "I";}
        if(sNcounterA > sNcounterB){collation += "S";} else {collation += "N";}
        if(tFcounterA > tfcounterB){collation += "T";} else {collation += "F";}
        if(jPcounterA > jPcounterB){collation += "J";} else {collation += "P";}
        checkPersonality();
    }
    ...
    public void checkPersonality(){
        ...
        System.out.println(allUserEntries[0][0] + "\n" + allUserEntries[1][0] + " " +
                ...
                + "\n" + "Number of B selected = " + eIcounterB);
        System.out.println();
        System.out.println(allUserEntries[0][1] + "\n" + allUserEntries[1][1] + " " +
                allUserEntries[2][1] + "\n" + allUserEntries[3][1] + "\n" + allUserEntries[4][1] +
                "\n" + "Number of A selected =  " + sNcounterA
                + "\n" + "Number of B selected = " + sNcounterB);
        System.out.println();
        System.out.println(allUserEntries[0][2] + "\n" + allUserEntries[1][2] + " " +
                allUserEntries[2][2] + "\n" + allUserEntries[3][2] + "\n" + allUserEntries[4][2] +
                "\n" + "Number of A selected =  " + tFcounterA
                + "\n" + "Number of B selected = " + tfcounterB);
        System.out.println();
        System.out.println(allUserEntries[0][3] + "\n" + allUserEntries[1][3] + " " +
                allUserEntries[2][3] + "\n" + allUserEntries[3][3] + "\n" + allUserEntries[4][3] +
                "\n" + "Number of A selected =  " + jPcounterA
                + "\n" + "Number of B selected = " + jPcounterB);
    ...
    public void displayOutput(){
        switch (collation){
            ...
            case "INFJ":
                ...
                break;
            default:
                System.out.println("Your Personality is Not among the 16 Personalities");
                break;
        }
    }
}
